...
export class UserGamificationService {
  ...
  public async createUserGamification(userId: string, userGamificationId: string, data: IUserGamification){
    return this.redis.getClient().hset(this.userGamificationKey(userId), userGamificationId, JSON.stringify(data));
  }

  public async updateUserGamification(userId: string, userGamificationId: string, data: IUserGamification){
    return this.redis.getClient().hset(this.userGamificationKey(userId), userGamificationId, JSON.stringify(data));
  }
