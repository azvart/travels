...
export abstract class UserQuestAbstractRepository {
  abstract attachQuestToUser(userId: string, questId: string | string[]):Promise<IUserQuest | IUserQuest[]>;
  abstract completeQuest(userId: string, questId: string | string[]):Promise<IUserQuest | IUserQuest[]>;
