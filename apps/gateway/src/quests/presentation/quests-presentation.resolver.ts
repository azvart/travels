...
export class QuestsPresentationResolver {
  ...
  public constructor(
    private readonly questsPresentationService:QuestsPresentationService
  ){}
  ...
  public async attacheQuestToUser(@Args('input') data:AttachQuestToUserDto, @CurrentUser() user: IGetUser){
  ...
  @Query(() => [UserQuestDto])
  public async findManyUserQuests(@Args('input') data:FindManyUserQuestDto,@CurrentUser() user:IGetUser){
