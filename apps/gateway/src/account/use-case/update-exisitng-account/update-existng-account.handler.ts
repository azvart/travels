...
@Injectable()
export class UpdateExistingAccountHandler {
  public constructor(private readonly accountGrpcService: AccountGrpcService) {}

  public async run(input: IUpdateAccountInput) {
    return firstValueFrom(this.accountGrpcService.service.updateAccount(input));
  }
}
